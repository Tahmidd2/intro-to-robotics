...
int main() {
    ...
    while(true) {
        ...
        if (RangeFinderC.foundObject()) {
            if (distanceInches > 40) {  // ~40 inches = ~1016mm
            ...
            else if (distanceInches > 20) {  // ~20 inches = ~508mm
            ...
            else if (distanceInches > 10) {  // ~10 inches = ~254mm
            ...
            else if (distanceInches < 5) {  // ~5 inches = ~127mm
                Drivetrain.stop();
